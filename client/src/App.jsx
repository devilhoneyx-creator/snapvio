...
import { Youtube, Instagram, Twitter, Facebook, CheckCircle } from 'lucide-react';
      ...
      <main className="flex-1 w-full flex flex-col">
        ...
        <section className="w-full hero-gradient pt-16 md:pt-24 pb-32 px-4 relative">
          <div className="max-w-[900px] mx-auto text-center">
            ...
            {/* The Downloader component holds the massive input and results */}
        ...
        <section className="w-full bg-[#0f1115] pt-32 md:pt-40 pb-20 px-4 -mt-16 relative z-10">
